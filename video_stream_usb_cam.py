...
class USBCamVideoStream:
    """USBCamVideoStream class to start camera capture in a seperate thread
    """

    def __init__(self, resolution=(320, 240), port=0):
        # initialize the camera and stream
        self.cap = cv2.VideoCapture(port)
        # self.cap.open('http://172.28.224.1:56000/mjpeg')
...
class SaveVideoStream:
    """class to save vidoe snapshot of the detected drowsiness events in a seperate thread
    """
